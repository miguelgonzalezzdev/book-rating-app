...
export function BookReviewCard({ review }: { review: Review }) {
    ...
    return (
        <>
            ...
            <BookReviewModal key={review.id} isOpen={showReviewModal} review={review} isLiked={isLiked} totalLikes={totalLikes} handleLike={handleLike} onClose={handleCloseReviewModal} />
        </>
    )
}
