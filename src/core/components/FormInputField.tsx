...
export function FormInputField({ id, name, type = "text", placeholder, value, onChange, error }: FormInputField) {
    const baseInputClasses = "w-full px-4 py-3 rounded-lg bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-50 placeholder-gray-400 dark:placeholder-neutral-400 focus:outline-none focus:ring-2";
